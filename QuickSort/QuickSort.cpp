...
int mov_count = 0; // numver of data movements
int n;
...
void q_short(int low, int high)
{
	...
	while (i <= j)                                     // Langkah 10
	{
		...
		cmp_count++;
		                                              ...
		                                              // Langkah 9
		if (i < j) // if the greater elemt is on the left of the element 
		{
	...
	//j now containts the index of the last element in the sorted list 
	if (low < j)                                      // Langkah 11
	{
...
void display() {
	...
	cout << "\n\nNumber pf comparasions: " << cmp_count << endl;
